package com.quran.administrator.quranapp.Base;
   ...
   public BaseActivity(){
    ...
    public void SaveData(String key,String value){
       SharedPreferences.Editor editor =
               getSharedPreferences("Quran_perfrences",MODE_PRIVATE)
               .edit();
    ...
    public String getData(String key){
        return getSharedPreferences("Quran_perfrences",MODE_PRIVATE)
                .getString(key,null);
    }
